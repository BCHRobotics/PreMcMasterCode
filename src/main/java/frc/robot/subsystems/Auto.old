...
*/
    ...
    while(lastTimeAuto < timeout){
        ...
        if(Robot.m_oi.ButtonCancelAutoD.get() == true){
            continue;
        }
    ...
    public void strafe(double GYROsetpoint, double ENCODERsetpoint, double GYROspeed, double ENCODERspeed, double timeout){
        ...
        while(lastTimeAuto < timeout){
            ...
            ENCODERerror = ENCODERsetpoint - Robot.m_drivetrain.getEncoderBL();
            ...
            Robot.m_drivetrain.mecanumDrive(-ENCODERrcw*ENCODERspeed,0, GYROrcw*GYROspeed, 0, 1);
    ...
    //Drive and turn
    public void turnDrive(double GYROsetpoint, double ENCODERsetpoint, double GYROspeed, double ENCODERspeed, double timeout){
    ...
    while(lastTimeAuto < timeout){
        ...
        Robot.m_drivetrain.mecanumDrive(0, -ENCODERrcw*ENCODERspeed, GYROrcw*GYROspeed, 0, 1);
