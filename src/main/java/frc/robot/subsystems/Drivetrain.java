...
public class Drivetrain extends Subsystem{
    ...
    public void setRamp(double rRate){

        SPARKLEFTBACK.setRampRate(rRate);
        SPARKLEFTFRONT.setRampRate(rRate);
        SPARKRIGHTBACK.setRampRate(rRate);
        SPARKRIGHTFRONT.setRampRate(rRate);
